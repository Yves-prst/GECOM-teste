...
--
-- Host: 127.0.0.1    Database: admin_system3
-- ------------------------------------------------------
...
CREATE TABLE `category_addons` (
  ...
  CONSTRAINT `category_addons_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE
...
INSERT INTO `goals` VALUES (1,200.00,0.00,7,2025,'2025-07-24 00:19:46'),(2,2000.00,0.00,8,2025,'2025-08-05 06:26:56'),(3,20000.00,0.00,9,2025,'2025-09-24 21:49:42'),(4,1000.00,0.00,10,2025,'2025-10-28 15:11:47');
...
INSERT INTO `mesas` VALUES (19,1,1,'disponivel'),(20,2,3,'disponivel'),(21,3,3,'disponivel'),(22,4,6,'disponivel');
...
INSERT INTO `sales` VALUES (12,11,'X Eggs',2,14.90,29.80,'2025-10-28 08:15:26'),(13,11,'X Eggs',1,14.90,14.90,'2025-10-28 14:43:34'),(14,14,'X BURGUI',3,14.00,42.00,'2025-10-28 15:09:23'),(15,14,'X BURGUI',1,14.00,14.00,'2025-10-28 15:09:58');
...
--
-- Dumping routines for database 'admin_system3'
--
...
-- Dump completed on 2025-10-28 12:21:42
