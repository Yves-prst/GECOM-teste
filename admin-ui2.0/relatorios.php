...
if (empty($weekData)) {
    $weekData = [
        ...
        ['product' => 'Pizza Margherita', 'quantity' => 18, 'total' => 270.00],
        ['product' => 'Refrigerante', 'quantity' => 45, 'total' => 135.00],
        ['product' => 'Batata Frita', 'quantity' => 30, 'total' => 120.00],
        ['product' => 'Sorvete', 'quantity' => 20, 'total' => 100.00]
    ];
}

if (empty($monthData)) {
    $monthData = [
        ['product' => 'Hambúrguer Especial', 'quantity' => 120, 'total' => 1800.00],
        ['product' => 'Pizza Margherita', 'quantity' => 85, 'total' => 1275.00],
        ['product' => 'Refrigerante', 'quantity' => 200, 'total' => 600.00],
        ['product' => 'Batata Frita', 'quantity' => 150, 'total' => 600.00],
        ['product' => 'Sorvete', 'quantity' => 90, 'total' => 450.00]
    ];
}
?>
